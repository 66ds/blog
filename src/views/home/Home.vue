  ...
  <div class="index">
    <div class="left">
      <search
        ...
        ref="search"
      />
      <div class="msg-message" v-custom-loading="info.searchSaveVos" v-if="info.searchSaveVos.length == 0">
        <!-- <p>空空如也</p> -->
        <img v-if="info.searchSaveVos.length > 0" src="~assets/empty/empty.png" />
      </div>
      <el-card
      ...
      <div
        class="pagination"
        v-if="info.searchSaveVos && info.searchSaveVos.length > 0"
      >
        <el-pagination
    ...
    <div class="right">
      ...
      <el-card class="right-box-card animated fadeIn">
        ...
        <div class="item" v-custom-loading="newTableHotData">
          <el-link
            :underline="false"
            @click="articleDetail(item.articleId)"
      ...
      <el-card class="right-box-card">
        ...
        <div class="item circle" v-custom-loading="newTableTimeData">
          <el-link
            :underline="false"
      ...
      <el-card class="right-box-card animated fadeIn">
        ...
        <div class="item" v-custom-loading="newTableNewData">
          <el-link
            :underline="false"
            @click="articleDetail(item.articleId)"
      ...
      <el-card class="right-box-card animated fadeIn">
        ...
        <div class="item circle" v-custom-loading="linkData">
          <el-link
            :underline="false"
...
<script>
import TagCloud from "components/tag/Tag";
