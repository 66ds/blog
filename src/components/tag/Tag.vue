<template>
  <div class="tagcloud-all" ref="tagcloudall" v-custom-loading="tagList">
    <a
...
export default {
  ...
  methods: {
    ...
    onMouseMove(event) {
      ...
      this.mouseX =
        oEvent.clientX - (this.oList.offsetLeft + this.oList.offsetWidth / 2);
      this.mouseX =
        oEvent.clientY - (this.oList.offsetTop + this.oList.offsetHeight / 2);
      this.mouseX /= 5;
      this.mouseY /= 5;
    },
    // 坐标更新 让标签动起来
