<template>
    <div class="tagcloud-all"
         ref="tagcloudall">
         <Loading v-if="tagList.length == 0"/>
         <a v-else v-for="item in tagList" animated fadeIn :href="item.url" :style="'color:' + item.color + ';top: 0;left: 0;filter:none;'"
    ...
    export default {
        ...
        methods: {
            ...
            onMouseMove(event) {
                ...
                this.mouseX = oEvent.clientY - (this.oList.offsetTop + this.oList.offsetHeight / 2);
                this.mouseX /= 5;
                this.mouseY /= 5;
            },
            // 坐标更新 让标签动起来
